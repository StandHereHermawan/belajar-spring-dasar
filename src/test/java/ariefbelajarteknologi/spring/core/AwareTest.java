...
import ariefbelajarteknologi.spring.core.service.AuthService;
...
public class AwareTest {
    ...
    void testAuth() {
        ...
        Assertions.assertEquals("ariefbelajarteknologi.spring.core.service.AuthService",authService.getBeanName());
